...
export default function Footer() {
  ...
  return (
    <footer className="pt-24 pb-12 border-t border-white/[0.05] mt-24 px-6 md:px-12 max-w-[1600px] mx-auto w-full">
      {/* Contact Me Section */}
      <div className="mb-16">
        <div className="glass-panel rounded-2xl p-8 md:p-12 text-center max-w-3xl mx-auto border border-white/10 hover:border-white/20 transition-all duration-500 group">
          ...
          <p className="text-white/60 text-base md:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/30 rounded-full transition-all duration-300 group-hover:scale-105"
          >
            <svg 
              className="w-6 h-6" 
              fill="currentColor" 
