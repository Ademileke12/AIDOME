    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.title ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.category ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.image ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors`}
              ...
              <div>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    ...
                    className="w-5 h-5 rounded border-white/20 bg-white/5 checked:bg-white checked:border-white"
                  />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.prompt ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors resize-none`}
            ...
            <>
              ...
              <div>
                    ...
                    <div key={index} className="flex items-center gap-3">
                      ...
                      {(formData.colors || ['']).length > 1 && (
                        <button
                          ...
                          className="w-10 h-10 flex items-center justify-center rounded-lg hover:bg-white/5 transition-colors text-white/40 hover:text-white/80"
                        >
                          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                          </svg>
                ...
                <button
                  type="button"
                  onClick={addColor}
                  className="mt-3 px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-colors editable-label"
                >
                  + Add Color
                </button>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.lighting ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors resize-none`}
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.description ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors resize-none`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.modules ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors`}
                />
                {errors.modules && (
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/5 border ${errors.videoUrl ? 'border-red-500/50' : 'border-white/10'} rounded-lg focus:outline-none focus:border-white/30 transition-colors`}
          ...
          {/* Form Actions */}
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-white/10">
            <button
              type="button"
              onClick={onCancel}
              className="w-full sm:flex-1 px-5 sm:px-6 py-2.5 sm:py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-colors editable-label text-sm sm:text-base"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="w-full sm:flex-1 px-5 sm:px-6 py-2.5 sm:py-3 bg-white text-black rounded-lg font-medium hover:bg-white/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
              {submitting ? (
